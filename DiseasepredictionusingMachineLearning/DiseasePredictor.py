...
# Heading
w2 = Label(root, justify=LEFT, text="Disease Predictor using Machine Learning", fg="red", bg="pink")
w2.config(font=("Typo Round", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="A Project by Harun", fg="red", bg="pink")
w2.config(font=("Typo Round", 30))
w2.grid(row=2, column=0, columnspan=2, padx=100)
root.title("Disease Predictor ML APP")
root.iconbitmap(r'C:\Users\Shimanto\Desktop\AI Lab\mlapp.ico')
# labels
